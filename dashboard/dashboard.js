...
async function getCurrentUser() {
    ...
    const res = await fetch('https://user-management-system-backend-rho.vercel.app/api/users', {
        method: 'GET',
        headers: {
...
async function fetchUsers() {
    try {
        ...
        // 🔹 Build API URL
        let url = `https://user-management-system-backend-rho.vercel.app/api/users/all?`;
...
updateProfileForm.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        const response = await fetch('https://user-management-system-backend-rho.vercel.app/api/users', {
...
async function deleteUser() {
    const deleteApi = await fetch('https://user-management-system-backend-rho.vercel.app/api/users', {

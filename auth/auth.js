...
async function createUser(fullName, email, age, password) {
    ...
    try {
        const addUserApi = await fetch('https://user-management-system-backend-mu.vercel.app/api/auth/signup', {
            method: 'POST',
            headers: {
...
async function loginUser(email, password) {
    try {
        const loginUserApi = await fetch('https://user-management-system-backend-mu.vercel.app/api/auth/login', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
async function verifyOtp(email) {
    ...
    try {
        let otpVerificationApi = await fetch('https://user-management-system-backend-mu.vercel.app/api/auth/verify-otp', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
